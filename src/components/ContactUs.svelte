...
<div class="grid md:grid-cols-2 md:gap:24 md:pt-16 pt-6">
        ...
        <div class="px-6 py-6 lg:px-8">
              <form class="space-y-6" action="#">
                ...
                <div>
                    ...
                    <input type="text" name="email" bind:value={userEmail} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 
